    ...
    <div class="formWrapper">
        <form class="commonForm" action="" method="POST">
            ...
            <div class="mt-10">
                ...
                <input type="text" name="updateID" id="updateID" value="">
            </div>
            <div>
                <label id="lblCurrentDeviceName">Current Device Name:</label>
                <input type="button" name="biometricCapture" value="Biometric Capture" onclick="captureBiometric('Update')">
                ...
                try
                {
                    if ($updateID != "" && $templateXML != "") {
                        ...
                        if (isset($_SESSION['access_token']) && $_SESSION['access_token'] != "") {
                            ...
                            $lblMessageText = $cloudABISConnector->Update($templateXML, $updateID, $_SESSION['access_token'], $templateFormat);
